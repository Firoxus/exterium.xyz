...
@del /s /f /a:h /a:a /q "%systemdrive%:\Users\%username%\AppData\Local\EpicGamesLauncher\Saved\HardwareSurvey\dxdiag.txt"
@del /s /f /a:h /a:a /q "%systemdrive%:\Users\%username%\AppData\Local\EpicGamesLauncher\Saved\Config\CrashReportClient"
